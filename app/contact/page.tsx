    ...
    return (
        <>
            ...
            <div className="md:hidden text-xs p-8 flex flex-col items-center gap-4">
                ...
                <Link className="hover:font-bold" href="mailto:sergeilevkofman@gmail.com"><u>sergeilevkofman@gmail.com</u></Link>
                <Link className="hover:font-bold" href="https://www.instagram.com/measure.music/"><u>Instagram</u></Link>
                <Link className="hover:font-bold" href="https://measuremakesmusic.bandcamp.com/"><u>Bandcamp</u></Link>
                <Link className="hover:font-bold" href="https://music.apple.com/ca/artist/measure/1518877528"><u>Apple Music</u></Link>
                <Link className="hover:font-bold" href="https://open.spotify.com/artist/2rLIZKbOabdPsr5Ls87Pfp"><u>Spotify</u></Link>
                <div className="text-center">References and more work available upon request.</div>
            </div>
        </>
    );
}