...
export const productionCredits: Record<string, MediaItem> = {
  ...
  when_limbs_die: {
    ...
    year: 2023,
    description1:
      "Recorded & played piano, recorded cello & flute, arranged piano, cello, & flute",
...
export const danceCredits: Record<string, MediaItem> = {
  ...
  bed: {
    ...
    year: 2025,
    description1:
      "Improvised Dance performance with Live Music Performance, in collaboration with Wolfang Gray and Samantha Goldman",
  ...
  fascia: {
    ...
    year: 2022,
    description1:
      "Theatrical Dance Production with Live Music Performance, in collaboration with Wolfang Gray",
...
export const orchestraWorks: Record<string, MediaItem> = {
  ...
  nips_and_porkington: {
    ...
    description2:
      "commissioned & premiered by the Scarborough Philharmonic Orchestra",
  },
  wings_of_fire: {
    title: "On Wings of Fire",
    year: 2018,
    description1:
      "Song Cycle for Solo Alto, Solo Clarinet, and String Orchestra",
    description2: "commissioned & premiered by the Whispering River Orchestra",
  },
  land_of_reflection: {
  ...
  haunted_house: {
    ...
    description2:
      "read & recorded by the University of Toronto Symphony Orchestra for the SCGC ORS",
  },
  walkabout: {
    title: "Walkabout",
    year: 2017,
...
export const chamberWorks: Record<string, MediaItem> = {
  change_and_stillness: {
    ...
    description2:
      "Recorded by Alex Toskov and Sergei Kofman, released as title track of EP",
  },
  wither_i_know_not: {
    ...
    description2:
      "Recorded by the Odin Quartet for the Scarborough Philharmonic Orchestra",
  },
  what_does_the_water_get_in_return: {
    ...
    description2:
      "Recorded by Thorwald Jorgensen and Kamilla Bystrova for the East Chamber Music Festival Series",
  },
  metonym: {
    title: "Metonym",
    year: 2019,
    description1:
      "Wind Orchestra (2 Fl., 2 Ob., 2 Cl., 2 Bs., 2Hn., 1 Tpt., Perc., String Bass)",
    description2:
      "Performed by musicians of the Scarborough Philharmonic Orchestra",
  },
  overgrowth: {
    title: "Overgrowth",
    year: 2018,
    ...
    description2:
      "Performed by the Ensemble Contemporain de Montreal, conducted by Veronique Lacroix, at a reading session at the University of Toronto in 2018, Premiered by the Atlantic Music Festival Contemporary Ensemble in 2019",
  },
  when_but_wain_we: {
    ...
    description2:
      "Premiered at Wilfrid Laurier University Faculty of Music Student Composer Concert",
  },
  septet: {
    title: "Septet",
    year: 2016,
